...
<html lang="id">
   <head>
      ...
      <meta name="keywords" content="sewa mobil, rental mobil, sewa kendaraan">
      <meta name="description" content="Haya Auto Express - Platform terbaik untuk sewa mobil di Indonesia">
      ...
      <section class="banner_main">
         <div class="container">
            <div class="row d_flex">
               <div class="col-md-12">
                  <div class="text-bg">
                     <h1>Temukan Mobil Terbaik untuk Disewa</h1>
                     <strong>Platform Sewa Mobil Terpercaya</strong>
                     <span>Landing Page 2023</span>
                     <p>
                        Kami menyediakan berbagai jenis mobil untuk kebutuhan Anda, baik untuk perjalanan bisnis, liburan, atau kegiatan lainnya. Temukan mobil yang sesuai dengan kebutuhan Anda hanya di Haya Auto Express.
                     </p>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     ...
                     <span>Kami menawarkan berbagai jenis mobil yang dapat disewa sesuai dengan kebutuhan Anda.</span>
                  </div>
               </div>
            </div>
            <div class="row">
                  ...
                  <div class="row">
                     <div class="col-md-12 offset-md-12">
                        <form class="main_form" id="predictForm">
                           <div class="titlepage">
                              <h2>Temukan Mobil Terbaik untuk Disewa</h2>
                           </div>
                           <div class="row">
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     ...
                     <span>Berikut alasan mengapa Anda harus memilih Haya Auto Express sebagai platform sewa mobil Anda.</span>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-12">
                  <div class="choose_box">
                     <span>01</span>
                     <p>Kami menyediakan berbagai jenis mobil yang dapat disewa dengan harga terjangkau dan proses yang mudah.</p>
                  </div>
               </div>
               <div class="col-md-12">
                  <div class="choose_box">
                     <span>02</span>
                     <p>Kami memiliki layanan pelanggan yang siap membantu Anda 24/7 untuk memastikan pengalaman sewa mobil Anda berjalan lancar.</p>
                  </div>
               </div>
               <div class="col-md-12">
                  <div class="choose_box">
                     <span>03</span>
                     <p>Kami menawarkan pilihan asuransi untuk memastikan Anda merasa aman dan terlindungi selama masa sewa.</p>
                  </div>
               </div>
            </div>
         </div>
                              ...
                              <div class="carousel-caption ">
                                 ...
                                 <div class="our cross_layout">
                                    <div class="test_box">
                                       <h4>Budi Santoso</h4>
                                       <span>Pengguna</span>
                                       <p>Saya sangat puas dengan layanan Haya Auto Express. Proses sewa sangat mudah dan mobil yang saya sewa dalam kondisi sangat baik.</p>
                              ...
                              <div class="carousel-caption">
                                 ...
                                 <div class="our cross_layout">
                                    <div class="test_box">
                                       <h4>Siti Aisyah</h4>
                                       <span>Pengguna</span>
                                       <p>Pengalaman sewa mobil di Haya Auto Express sangat memuaskan. Layanan pelanggan sangat responsif dan membantu.</p>
                                       <i><img src="<?php echo e(asset('images/te1.png')); ?>" alt="#"/></i>
                                    </div>
                                 </div>
                              </div>
         ...
         <div class="footer">
                  ...
                  <div class="col-md-12">
                     ...
                     <div class="cont">
                        <h3> <strong class="multi"> Haya Auto Express</strong> 
                           Platform Sewa Mobil Terbaik 2023
                        </h3>
                     </div>
                  </div>
               </div>
            ...
            <div class="copyright">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <p>© 2023 Hak Cipta Dilindungi. Desain oleh <a href="https://html.design/">Template HTML Gratis</a></p>
                     </div>
                  </div>
               </div>
            </div>
...
<?php /**PATH C:\xampp_8_2\htdocs\iya\resources\views/welcome.blade.php ENDPATH**/ ?>